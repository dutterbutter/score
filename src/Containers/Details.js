...
import Batters_Home from '../Components/Games/BattersHome';
import Batters_Away from '../Components/Games/BattersAway';
    ...
    return (
        <div>
            <LineScore
                ...
                innings={props.detailData.linescore ? props.detailData.linescore.inning_line_score : ['1', '2']}
